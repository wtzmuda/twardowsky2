function [Fuel_Input, Grain_Struct, Engine_Parameters, Ambient_Input, Simulation_Settings] = AA_A2HRM_Input()
...
Grain_Struct(grain_number).Grain_stl_filename = '/InputFiles/STL/grain_A2HRM_16_80.stl';
...
Grain_Struct(grain_number).coordinate_frame_axes = [1,2,3];
...
%Tank input data
Engine_Parameters.Tank_Oxidizer.volume = 0.008327734;                % Tank volume     
...
Engine_Parameters.Tank_Oxidizer.oxidizer_total_mass = 3.8;           % The initial mass oxidizes in the tank
...
Engine_Parameters.Feed_Input.discharge_coefficient = 0.331;    % Power loss factor
Engine_Parameters.Feed_Input.orifices_number = 1;         % Number of orrifices in the injection plate
Engine_Parameters.Feed_Input.orifices_diameter = 0.003;   % The diameter of the holes in the injection plate
...
Engine_Parameters.Nozzle_Input.entry_diameter = 0.032;                        %Diameter [m] of nozzle entry
Engine_Parameters.Nozzle_Input.throat_diameter = 0.0095;                      %Diameter [m] of nozzle throat
Engine_Parameters.Nozzle_Input.exit_diameter = 0.028;                         %Diameter [m] of nozzle exit
Engine_Parameters.Nozzle_Input.throat_rounding_radius_1 = 0.003;              %Radius [m] of the rounding before the nozzle throat
Engine_Parameters.Nozzle_Input.throat_rounding_radius_2 = 0.005;              %Radius [m] of the rounding after the nozzle throat
Engine_Parameters.Nozzle_Input.convergent_length = 0.00982;                   %Distance [m] from the nozzle entry to the nozzle throat
Engine_Parameters.Nozzle_Input.throat_length = 0.00159;                       %Length [m] of the constant diameter section before nozzle throat
Engine_Parameters.Nozzle_Input.divergent_length = 0.03518;                    %Distance [m] from the nozzle throat to the nozzle exit
...
Simulation_Settings.time_max = 15;                     %Simulation time [s]
...
Simulation_Settings.Plots_Settings.fuel_mass_flow_rate = false;
...
Simulation_Settings.Plots_Settings.temperature_combustion = false;
...
Simulation_Settings.Plots_Settings.pressure_drop = false;
