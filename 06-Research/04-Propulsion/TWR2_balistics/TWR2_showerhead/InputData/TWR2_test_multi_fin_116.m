...
Fuel_Input.burn_coefficient = 0.358;                     %Temperature coefficient [mm/s] HTPB- 0.38 
Fuel_Input.burn_expo = 0.198;                             %Burn rate exponent [-], Gox is in g/(s*cm^2) HTPB- 0.198 
...
Engine_Parameters.Chamber_Input.volume = 0.0066; 
...
Engine_Parameters.Chamber_Input.crosssection_area = pi*0.06^2;

%Tank input data
Engine_Parameters.Tank_Oxidizer.volume = 0.023;                % Tank volume     
...
Engine_Parameters.Tank_Oxidizer.oxidizer_total_mass = 16;           % The initial mass oxidizes in the tank
...
Engine_Parameters.Feed_Input.orifices_number = 300;         % Number of orrifices in the injection plate
...
Engine_Parameters.Nozzle_Input.throat_diameter =  0.045;  %Diameter [m] of nozzle throat
...
Simulation_Settings.time_step = 0.002;                %Time step for calculations [s]
